...
if (isset($_GET['id'])) {
    ...
    // Fetch blog details to get the image filename
    $result = $conn->query("SELECT image FROM blog_posts WHERE id = $id");
    $blog = $result->fetch_assoc();
    
    if ($blog) {
        // Delete the blog image file
        $image_path = "../assets/images/blog_images/" . $blog['image'];
...
<body class="bg-gray-100 dark:bg-gray-900">
    ...
    <main class="ml-64 p-8 pt-24">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg animate__animated animate__fadeIn">
            ...
            <a href="manage_blog.php" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg transition duration-300 ease-in-out inline-block">
